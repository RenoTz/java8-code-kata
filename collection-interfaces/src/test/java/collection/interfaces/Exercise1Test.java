...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void iterateByForEach() {
        ...
        /**
         * Create a {@link Consumer} which represents an operation to add customer's name to {@link nameList} list. Iterate
         * {@link customerIterable} with {@link Iterable#forEach} and use the {@link Consumer} to finish creating the name list.
         */
    ...
    public void whoHaveNoEInYourName() {
        ...
        /**
         * Create a {@link Predicate} which predicates if the input string contains "e". Remove elements from {@link nameCollection} which
         * contains "e" using {@link Collection#removeIf}.
         */
    ...
    public void replaceTheElements() {
        ...
        /**
         * Create a {@link UnaryOperator} which returns given string wrapped with "()". Replace the elements in {@link nameList} with string
         * wrapped with "()" using {@link List#replaceAll} .
         */
        UnaryOperator<String> unaryOperator = x -> x.replace(x, "(" + x + ")");
    ...
    public void sortByName() {
         ...
         */
        Comparator<String> comparator = (x1, x2) -> new Integer(x1.length()).compareTo(new Integer(x2.length()));
    ...
    public void createStream() {
        ...
        /**
         * Create a serial {@link Stream} using {@link Collection#stream} You can learn about {@link Stream} APIs at stream-api module.
         */
