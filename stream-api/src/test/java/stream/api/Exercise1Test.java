...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void findRichCustomers() {
        ...
        /**
         * Create a {@link Stream} from customerList only including customer who has more budget than 10000. Use lambda expression for Predicate
         * and {@link Stream#filter} for filtering.
         */
    ...
    public void howOldAreTheCustomers() {
        ...
        /**
         * Create a {@link Stream} from customerList with age values. Use method reference(best) or lambda expression(okay) for creating
         * {@link Function} which will convert {@link Customer} to {@link Integer}, and then apply it by using {@link Stream#map}.
         */
