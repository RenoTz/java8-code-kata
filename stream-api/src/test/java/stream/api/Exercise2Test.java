...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
        ...
        /**
         * Create a stream with ascending ordered age values. Use {@link Stream#sorted} to sort them.
         */
    ...
    public void itemsCustomersWantToBuy() {
        ...
        /**
         * Create a stream with items' names stored in {@link Customer.wantToBuy} Use {@link Stream#flatMap} to create a stream from each element
         * of a stream.
         */
        ...
        assertThat(itemList,
                        contains("small table", "plate", "fork", "ice cream", "screwdriver", "cable", "earphone", "onion", "ice cream",
                                        "crisps", "chopsticks", "cable", "speaker", "headphone", "saw", "bond", "plane", "bag", "cold medicine",
                                        "chair", "desk", "pants", "coat", "cup", "plate", "fork", "spoon", "ointment", "poultice", "spinach",
                                        "ginseng", "onion"));
    }
}
